...
class PsdDivider:
    ...
    def execute(self, psd_file_path, output_folder_path, encoding="cp932"):
        ...
        for layer in list(psd.descendants(include_clip=False)):
            if (layer.is_group()):
                ...
                self.storeLayerInfo(layer, folder_path, depend_group_len, depend_group_name)
                if depend_group_len > 0:
                    depend_group_len = 0
                    depend_group_name = ""
    ...
    def storeLayerInfo(self, layer, folder_path, depend_group_len=0, depend_group_name=""):
        ...
        layer_info = {
            ...
            "depend_group_len": depend_group_len,
            "depend_group_name": depend_group_name
        }
